...
teach undergraduate {\bf Compilers} and {\bf Programming Languages} courses.            
All three PIs plan on creating a cross-listed Physics/Computer Science course focusing
on alogirthmic implementations of physics problems. The coures will be geared toward
advanced undergraduates in Physics and Computer Science.  Software developed under this
proposal will be leveraged in the classroom to exemplify pratical aspects of the work.


{\bf Graduate (G) level.}  
Co-PI Ko teaches graduate {\bf Distributed Systems} and {\bf Android} courses. Co-PI Ziarek will
teaches graduate {Programming Languages} courses.  The PIs plan on teaching a graduate version
of their proposed undergraduate coures, focusing on advnaced techniques and implementation
details at the systems level.  Students who successfully complete the course will be well suited to
begin research at the intersection of partical physics and computer science. To help support
...
undergradutes, including Mr. Goodrum. Mr. Goodrum is participating in the
...
% LocalWords:  pileup PU AK pseudorapidity Aachen CA Ziarek's
