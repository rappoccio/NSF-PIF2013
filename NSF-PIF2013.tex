...
(HLLHC). Unfortunately, since the mid-2000's, this improvement
...
capabilities of particle physics experiments in the HLLHC era, it will
...
experience shows that this nearest-neighbor type of algorithm used by
...
specific case, this research focuses on one particular algorithm, jet
clustering, for immediate improvements, although the principles
...
several minutes per event. Furthermore, in future runs of the LHC
...
$N^2\log{N}$. This will serve as a real-world test case for the
deployment of these algorithms.  
...
His research interest include utilizing jet clustering algorithms in
...
developed here at the cutting edge of scientific inquiry will be easily
...
He is currently advising one undergraduate students in his group,
