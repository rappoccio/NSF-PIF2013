...
Smartphone Testbed'' on 06/01/12. The award number is 1205656 and the amount is
\$1,358,510.00. The duration is for three years. The results include the
following.
...
use; there are roughly 300 participants and multiple experiments are either
